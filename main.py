...
def about_app(event=None):
    ...
    _link_program = tk.Label(right_frame, bg="white", cursor="hand2", text="passion-lab.github.io/Py-NibPAD/")
    _link_program.grid(row=5, column=1, sticky="w")
    _link_program.bind('<Button-1>', lambda e=None: open_new_tab("https://passion-lab.github.io/Py-NibPAD/"))
    ...
    _link_wa = tk.Label(right_frame, bg="white", cursor="hand2", text="wa.me/...")
    _link_wa.grid(row=7, column=1, sticky="w")
    _link_wa.bind('<Button-1>', lambda e=None: open_new_tab("https://wa.me/9733554698?text=I'm%20interested%20in%20"))
    tk.Label(right_frame, bg="white", image=icon_telegram).grid(row=8, column=0, sticky="w")
    _link_tg = tk.Label(right_frame, bg="white", cursor="hand2", text="t.me/...")
    _link_tg.grid(row=8, column=1, sticky="w")
    _link_tg.bind('<Button-1>', lambda e=None: open_new_tab("https://t.me/ss_encp"))
